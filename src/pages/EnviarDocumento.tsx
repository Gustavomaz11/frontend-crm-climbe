        ...
        <div className="p-6 border-b border-border/20">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[12px] text-muted-foreground mt-1">Anexe o arquivo solicitado pela equipe Climbe.</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-5">
          {loading ? (
            ...
            <div className="rounded-xl border border-accent/20 bg-accent/10 p-5 text-center">
              ...
              <p className="text-[12px] text-muted-foreground mt-1">O arquivo foi recebido e seguirá para análise.</p>
            </div>
          ) : error && !info ? (
            ...
            <>
              <div className="rounded-xl border border-border/20 bg-background/45 p-4 space-y-3">
                <div>
                  <p className="text-[10px] text-muted-foreground uppercase tracking-wider">Documento solicitado</p>
              ...
              >
                ...
                <p className="text-[11px] text-muted-foreground mt-1">PDF, DOC, DOCX, XLS, XLSX ou imagem</p>
              </div>
